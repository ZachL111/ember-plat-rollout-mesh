...
$repo = "ember-plat-rollout-mesh"
$language = "Java"
$category = "Platform engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/ember-plat-rollout-walkthrough.md")) {
