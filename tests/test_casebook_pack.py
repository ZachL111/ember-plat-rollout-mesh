"""Regression checks for the ember-plat-rollout-mesh casebook."""
...
from casebook.harness import assert_expected, ember_plat_rollout_mesh_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ember_plat_rollout_mesh_summary(), assert_expected())
